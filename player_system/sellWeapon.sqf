...
private["_switch","_primary","_magazines","_magazine","_i","_weapon_value","_magPrice","_magSell"];
_primary = currentWeapon player; //Fetch their current weapon in their hand...
...
_amount = {_x==_magazine} count magazines player; //Amount of magazines.
...
player setVariable ["cmoney", (player getVariable ["cmoney", 0]) + _magSell, true];
