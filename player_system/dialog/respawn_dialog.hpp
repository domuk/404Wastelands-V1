...
class RespawnSelectionDialog {
	...
	class controls {
		class RandomButton:w_RscButton {
			...
			text = "";
			onButtonClick = "-1 call client_respawnAction;";
		...
		class CityButton1:w_RscButton {
			...
			text = "";
			onButtonClick = "0 call client_respawnAction;";
		...
		class CityButton2:CityButton1 {idc = respawn_button_city + 1; onButtonClick = "1 call client_respawnAction;"; y = 0.46;};
		class CityButton3:CityButton1 {idc = respawn_button_city + 2; onButtonClick = "2 call client_respawnAction;"; y = 0.52;};
		class CityButton4:CityButton1 {idc = respawn_button_city + 3; onButtonClick = "3 call client_respawnAction;"; y = 0.58;};
		class CityButton5:CityButton1 {idc = respawn_button_city + 4; onButtonClick = "4 call client_respawnAction;"; y = 0.64;};
	};
};