			...
			switch(_data) do 
				{
					...
					case "fuelFull": 
					{
						[] call compile preProcessFile "core\misc\refuel.sqf";
					};
					...
					case "repairkits": 
					{
						[] call compile preProcessFile "core\misc\repair.sqf";
					};
					...
					case "rabitmeat": {
						hint "You need to cook it on fireplace first";
					};
					case "rabitmeatc":
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["rabitmeatc",(player getVariable "rabitmeatc")-1,true];
					...
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["cowmeatc",(player getVariable "cowmeatc")-1,true];
					...
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["goatmeatc",(player getVariable "goatmeatc")-1,true];
							hungerLevel = hungerLevel + 30;
							if(hungerLevel > 100) then {hungerLevel = 100};
					...
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["boarmeatc",(player getVariable "boarmeatc")-1,true];
					...
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["chickenmeatc",(player getVariable "chickenmeatc")-1,true];
							hungerLevel = hungerLevel + 20;
							if(hungerLevel > 100) then {hungerLevel = 100};
					...
					{
						if((vehicle player) == player) then { player playmove "AinvPknlMstpSnonWnonDnon_healed_1"; };
							player setVariable["sheepmeatc",(player getVariable "sheepmeatc")-1,true];
							hungerLevel = hungerLevel + 30;
							if(hungerLevel > 100) then {hungerLevel = 100};
							hint format["You have eaten some sheep meat\nHunger Level: %1",hungerLevel];
							sleep  1;
							player playmove "AinvPknlMstpSnonWnonDnon_healed_1";
					};
