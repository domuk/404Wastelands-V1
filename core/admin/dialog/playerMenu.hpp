class PlayersMenu
{
	...
	{
		idc=13371;
		onLBSelChanged="[2,_this select 1] execVM ""core\admin\importvalues.sqf"";";
		x=-0.38;
		y=-0.13;
		w=1.72;
		h=0.47;
	...
	class PlayersMenu_activate2:RscButton
	{
		idc=19001;
		text="Cam";
		action="[1] execVM ""core\admin\playerSelect.sqf"";";
		x=0.92;
		y=0.44;
		w=0.15;
		h=0.05;
	...
	class PlayersMenu_activate3:RscButton
	{
		idc=-1;
		text="Warn";
		action="[2] execVM ""core\admin\playerSelect.sqf"";";
		x=1.10;
		y=0.44;
		w=0.15;
		h=0.05;
